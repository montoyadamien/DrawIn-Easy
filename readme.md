...
- Wait for some seconds (the larger the drawing area is, the longer the duration will be) and the bot will automatically choose the right colors to drawn between the two points you gave.
